        ...
        return (
          <div className="step">
            ...
            <div className="form-group">
              ...
              <input type="text" name="handlowiec" value={formData.handlowiec} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Imię i nazwisko</label>
              <input type="text" name="imieNazwisko" value={formData.imieNazwisko} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Telefon</label>
            ...
            <div className="form-group">
              ...
              <input type="text" name="peselNip" value={formData.peselNip} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Dowód</label>
              <input type="text" name="dowod" value={formData.dowod} onChange={handleChange} required />
            </div>
            <div className="form-group">
        ...
        return (
          <div className="step">
            ...
            <div className="form-group">
              ...
              <input type="text" name="miejscowosc" value={formData.miejscowosc} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Kod pocztowy</label>
              <input type="text" name="kodPocztowy" value={formData.kodPocztowy} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Powiat</label>
            ...
            <div className="form-group">
              ...
              <input type="text" name="wojewodztwo" value={formData.wojewodztwo} onChange={handleChange} required />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" name="adresMiejscowosc" value={formData.adresMiejscowosc} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Adres Kod Pocztowy</label>
              <input type="text" name="adresKodPocztowy" value={formData.adresKodPocztowy} onChange={handleChange} required />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" name="adresWojewodztwo" value={formData.adresWojewodztwo} onChange={handleChange} required />
            </div>
            <div className="navigation">
              <button type="button" className="action-button secondary" onClick={prevStep}>
                Wstecz
              </button>
              <button type="button" className="action-button" onClick={nextStep}>
                Dalej
        ...
        return (
          <div className="step">
            ...
            <div className="form-group">
              ...
              <input type="text" name="czyPosiadaInstalacje" value={formData.czyPosiadaInstalacje} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Miejsce instalacji (opcjonalne)</label>
              <input type="text" name="miejsceInstalacji" value={formData.miejsceInstalacji} onChange={handleChange} />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" name="miejsceMontazu" value={formData.miejsceMontazu} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Łańcuchy (opcjonalne)</label>
              <input type="text" name="lancuchy" value={formData.lancuchy} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Licznik lokalizacja (opcjonalne)</label>
              <input type="text" name="licznikLokalizacja" value={formData.licznikLokalizacja} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Zasięg internetu (opcjonalne)</label>
              <input type="text" name="zasiegInternetu" value={formData.zasiegInternetu} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Dwie kreski (opcjonalne)</label>
              <input type="text" name="dwieKreski" value={formData.dwieKreski} onChange={handleChange} />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" name="fazowa" value={formData.fazowa} onChange={handleChange} />
            </div>
            <div className="form-group">
        ...
        return (
          <div className="step">
            ...
            <div className="form-group">
              ...
              <input type="text" name="numerUmowy" value={formData.numerUmowy} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Operator OSD</label>
              <input type="text" name="operatorOsd" value={formData.operatorOsd} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Czy właściciel licznika</label>
              <input type="text" name="czyWlascicielLicznika" value={formData.czyWlascicielLicznika} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Cena brutto</label>
              <input type="number" step="0.01" name="cenaBrutto" value={formData.cenaBrutto} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Pierwsza wpłata</label>
              <input type="number" step="0.01" name="pierwszaWplata" value={formData.pierwszaWplata} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Sposób płatności 1</label>
              <input type="text" name="sposobPlatnosci1" value={formData.sposobPlatnosci1} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Czy jedna wpłata</label>
              <input type="text" name="czyJednaWplata" value={formData.czyJednaWplata} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Druga wpłata (opcjonalne)</label>
              <input type="number" step="0.01" name="drugaWplata" value={formData.drugaWplata} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Sposób płatności 2 (opcjonalne)</label>
              <input type="text" name="sposobPlatnosci2" value={formData.sposobPlatnosci2} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Powierzchnia domu (opcjonalne)</label>
              <input type="text" name="powierzchniaDomu" value={formData.powierzchniaDomu} onChange={handleChange} />
            </div>
            <div className="form-group">
              ...
              <div className="products-selection">
                {products.map((product) => (
                  <label key={product} className="product-checkbox">
                    ...
                    />
                    <span className={`product-tag product-${product.toLowerCase().replace(' ', '-')}`}>
                      {product}
                    </span>
                  </label>
                ))}
        ...
        return (
          <div className="step">
            ...
            <div className="form-group">
              ...
              <input type="text" name="banerZamontowany" value={formData.banerZamontowany} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Wynagrodzenie handlowca (opcjonalne)</label>
              <input type="number" step="0.01" name="handlowiecWynagrodzenie" value={formData.handlowiecWynagrodzenie} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Rodzaj klienta</label>
              <input type="text" name="rodzajKlienta" value={formData.rodzajKlienta} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>Data podpisania</label>
              <input type="date" name="dataPodpisania" value={formData.dataPodpisania} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label>User ID</label>
            ...
            <div className="form-group">
              ...
              <textarea name="opisUmowyBOK" value={formData.opisUmowyBOK} onChange={handleChange} required />
            </div>
            <div className="navigation">
              <button type="button" className="action-button secondary" onClick={prevStep}>
                Wstecz
  ...
  return (
    <div className="utworz-umowe">
      ...
      <div className="step-indicator">
        ...
        <span className={step === 5 ? 'active' : ''}>5. Dodatkowe informacje</span>
      </div>
      {renderStep()}
    </div>
  );
